...
class BinarySearchTree:
    ...
    def bfs(self):
        ...
        return lista
    def bfsR(self,queue,lista1):
        if len(queue)==0:
            return lista1
        else:
            currentnode=queue.popleft()
            lista1.append(currentnode.value)
            if currentnode.left is not None:
                queue.append(currentnode.left)
            if currentnode.right is not None:
                queue.append(currentnode.right)
            return self.bfsR(queue,lista1)
        
    def bfsR2(self):
        queue1=deque([self.root])
        lista2=[]
        return self.bfsR(queue1,lista2)
    
    def traverseInOrder(self,node, lista1):
        if node is None:
            return lista1
        else:    
            if node.left is not None:
                self.traverseInOrder(node.left,lista1)
            lista1.append(node.value)
            if node.right is not None:
                self.traverseInOrder(node.right,lista1)
        return lista1
    def traversePreOrder(self,node, lista1):
        if node is None:
            return lista1
        else: 
            lista1.append(node.value)
            if node.left is not None:
                self.traversePreOrder(node.left,lista1)
            if node.right is not None:
                self.traversePreOrder(node.right,lista1)
        return lista1
    
    def traversePostOrder(self,node, lista1):
        if node is None:
            return lista1
        else: 
            if node.left is not None:
                self.traversePostOrder(node.left,lista1)
            if node.right is not None:
                self.traversePostOrder(node.right,lista1)
            lista1.append(node.value)
        return lista1
    ...
    def dfsInOrder(self):
        lista2=[]
        return self.traverseInOrder(self.root,lista2)
    

    
    def dfsPreorder(self):
        lista3=[]
        return self.traversePreOrder(self.root,lista3)
    
    def dfsPostorder(self):
        lista4=[]
        return self.traversePostOrder(self.root,lista4)
